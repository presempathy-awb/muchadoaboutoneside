...
[iani’s guide to aluminum on wood](https://muchadoaboutoneside.com/instructions#large-sculpture) covers continuous support versus open ribs, paper patterns on the actual sculpture, a complete wood/finish/adhesive sample, forming and trimming, panel-by-panel attachment, and final seam and clearance checks. Its downloadable text copy comes from the same content as the page. This is a proposed fitting sequence; the existing large panel files remain conceptual references. The actual stock, wood finish, support, adhesive system, and indoor/outdoor conditions must be confirmed before installation. Manufacturer guidance is linked in the guide. Fable’s copperplate brief and physical print templates are preserved.
