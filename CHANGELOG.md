...
This log records notable project changes. Repository history and pull requests carry detailed implementation and validation evidence.
...
- Added a six-foot indoor display construction study comparing supported aluminum, aluminum-composite panels and conditional alternatives, with sample and base-design decisions.
- Revised the internal platform proposal and its evidence gates; this did not activate new platform services.

## Existing studio

The studio includes the original figure-eight model and archive, canonical and extended poem views, browser-local poem editing with an optional shared relay, calligraphy guidance, large and 180 mm fabrication studies, aluminum-on-wood and packing instructions, and a proposed Enceladus/chimera projection plan. See the [README](README.md) for provenance, limitations and credits.
