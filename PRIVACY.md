...
The site links to external services, including source hosting and the artist's profile. Their privacy policies apply when you visit them. Original model assets and public downloads are intentionally published; private style-reference photography is excluded.
